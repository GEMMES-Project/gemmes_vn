...
function readMore(package) {
    var dots = document.querySelector(`.card[data-package="${package}"] .dots`);
    var moreText = document.querySelector(`.card[data-package="${package}"] .more`); 
    var btnText = document.querySelector(`.card[data-package="${package}"] .myBtn`);
