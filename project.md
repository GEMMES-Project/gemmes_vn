...
<p class="longtext">The results of the Gemmes VN project will feed into the preparation of the different components of Vietnamese climate action by providing upstream technical and scientific notes, the priorities of which will be discussed with the Climate Change Department of MONRE, as permanent secretariat of the NCCC. The VN Gems project has a new objective to provide an integrated, open and as comprehensive as possible analytical framework for damage and adaptation issues in Viet Nam. </p>
...
<h1>4- Beneficiaries of the VN Gems project   </h1>
...
<p class="longtext">Two types of indirect beneficiaries are considered:  
...
<p class="longtext">The GEMMES Vietnam project is structured around 3 circles:  
- an academic circle at the heart of the programme, which will autonomously develop its research (Axes 1 to 6), while using privileged access to public data thanks to the institutional circle and feeding into diagnoses and policy recommendations on the subjects of damage and adaptation.  
...
- Finally, a public circle, which will promote the dissemination of information on the impacts of climate change and possible resilience strategies, while also feeding the diagnosis of researchers and politicians through closer contact with the different currents in society.  
